...
void gdt_init(void) {
    ...
    g_gdt[5] = make_seg((uint32_t)tss_base, tss_limit, 0x89, 0x0);
    /* Upper 32 bits of base in slot 6 */
    g_gdt[6] = (uint64_t)((tss_base >> 32) & 0xFFFFFFFF);
