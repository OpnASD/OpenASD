...
static void out_uptime(uint64_t ticks_10ms) {
    ...
    outch((char)('0' + (hours / 10) % 10));
    outch((char)('0' + hours % 10));
    outch(':');
    outch((char)('0' + (mins / 10) % 10));
    outch((char)('0' + mins % 10));
    outch(':');
    outch((char)('0' + (secs / 10) % 10));
    outch((char)('0' + secs % 10));
}
...
int main(int argc, const char **argv, const char **envp) {
    ...
    out_field("Kernel", uts.release[0] ? uts.release : "0.1.0");
    out("  Uptime: ");
